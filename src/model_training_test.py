...
# Load the dataset
data = pd.read_csv(r'data/raw/processed/Narwal/Cherry_Small_dataset.csv')
...
train_data = available_data[available_data['ds'] < '2024-05-15']
test_data = available_data[available_data['ds'] >= '2024-05-15']
...
def random_forest_model(train_data, test_data):
    ...
    train_subset = train_data[train_data['ds'] < '2023-05-15']
    val_subset = train_data[(train_data['ds'] >= '2023-05-15') & (train_data['ds'] < '2024-05-15')]
...
def save_plot(y_true, y_pred, model_name, dates):
    ...
    plot_dir = os.path.join("model_results","Narwal","Cherry_Small", model_name)
    ...
    if args.model:
        if args.model in models_to_run:
            ...
            try:
                ...
                result_dir = os.path.join("model_results","Narwal","Cherry_Small", args.model)
